  ...
  <div class="flex flex-col items-center">
    <div class="relative mb-8">
      ...
      <div class="flex items-center absolute bottom-0 left-0 -mb-8 z-20 ml-12">
        <div class="w-32">
            <img src="https://www.diethelmtravel.com/wp-content/uploads/2016/04/bill-gates-wealthiest-person.jpg" alt="" class="object-cover w-32 h-32 border-4 border-gray-200 rounded-full">
        </div>
